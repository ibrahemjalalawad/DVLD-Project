...
namespace DVLD_Project.Applications.Local_Driving_License
{
    public partial class frmAddEditLocalDrivingLicenseApplications : Form
    {
        ...
        public frmAddEditLocalDrivingLicenseApplications(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        private void _LoadData()
        {
            ...
            ctrlPersonDeatailsWithFilter1.FilterEnabled = false;
            ...
            ctrlPersonDeatailsWithFilter1.LoadPersonInfo(_LocalDrivingLicenseApplication.ApplicantPersonID);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (clsLicense.IsLicenseExistByPersonID(ctrlPersonDeatailsWithFilter1.PersonID, LicenseClassID))
            {
            ...
            _LocalDrivingLicenseApplication.ApplicantPersonID = ctrlPersonDeatailsWithFilter1.PersonID; ;
        ...
        private void frmAddEditLocalDrivingLicenseApplications_Activated(object sender, EventArgs e)
        {
            ctrlPersonDeatailsWithFilter1.FilterFocus();
        }

        private void ctrlPersonDeatailsWithFilter1_OnPersonSelected_1(int obj)
        {
