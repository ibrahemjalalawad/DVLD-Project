...
using static BussinessLayesDVLD.clsTestTypes;
...
namespace DVLD_Project.Tests
{
    public partial class frmManageTestAppointments : Form
    {
        ...
        public frmManageTestAppointments(int LocalDrivingLicenseApplicationID, clsTestTypes.enTestType TestType)
        {
            InitializeComponent();
                ...
                case clsTestTypes.enTestType.StreetTest:
                    {
                        ...
                        this.Text = lblTitle.Text;
                        pbTestTypeImage.Image = Resources.wallpaper;
                        break;
                    }
            }
        }
