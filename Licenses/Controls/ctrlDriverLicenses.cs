...
namespace DVLD_Project.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("No Driver With Driver ID = " + DriverID, "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("No Driver linked with this With Person ID = " + PersonID, "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        public void Clear()
        {
            ...
            //clear is a ready function from datatable implemntation
