...
{
    public partial class frmIssueLicesneForTheFirstTime : Form
    {
        private int _LocalDrivingLicenseApplicationID;
        private clsLocalDrivingLicenseApplication _LocalDrivingLicenseApplication;
        public frmIssueLicesneForTheFirstTime(int LocalDrivingLicenseApplicationID)
        {
            InitializeComponent();
        ...
        private void frmIssueLicesneForTheFirstTime_Load(object sender, EventArgs e)
        {
            txtNotes.Focus();
